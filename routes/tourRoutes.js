...
router.route('/monthly-plan/:year').get(authController.protect, authController.restrictTo('admin', 'guide', 'lead-guide'), tourController.monthlyPlans);
...
//doesn't belong here as the resource concerned is reviews although route starts with tours
// router.route('/:tourId/reviews').post(authController.protect, authController.restrictTo('user'), reviewController.createNewReview);
//works for both get and post routes!
