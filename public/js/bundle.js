      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', "updated ".concat(type === 'data' ? 'details' : 'password', " successfully"));
              location.reload();
            }
...
var pk = 'pk_test_51LqUe7SEjcN9V2xIDZMj2q9fP2ZBlXoPrBxgsPEu2M7KVj1OpCZMfQLrLMIg6x4jrF5VzKAfqpIx0mwGI0qnweDe00nEIWn6Lq';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //Create checkout form + payment UI
